    ...
    <section className="relative z-30 md:-mt-12 mb-12 -mt-24">
      <div className="container mx-auto px-4">
        <div className="bg-white rounded-[2rem] shadow-2xl shadow-blue-900/10 border border-slate-100 p-6 md:p-12 overflow-hidden relative group">
          <div className="absolute top-0 right-0 w-64 h-64 bg-secondary/5 rounded-full blur-3xl -mr-32 -mt-32 transition-transform duration-1000 group-hover:scale-110" />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 relative z-10">
            {stats.map((stat, idx) => (
              ...
              >
                ...
                <div>
                  <div className="text-2xl md:text-4xl font-black text-primary mb-1 tracking-tight">
                    {stat.value}
                  </div>
